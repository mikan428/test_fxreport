...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    {
        if( TextUtils.isEmpty(full_name_profile_frag.text.toString()))
        {
            Toast.makeText(this,"plsease write full name first", Toast.LENGTH_LONG).show()
        ...
        {
            Toast.makeText(this,"plsease write user name first", Toast.LENGTH_LONG).show()

        }
        else  if( bio_profile_frag.text.toString() == "")
        {
            Toast.makeText(this,"plsease write your bio first", Toast.LENGTH_LONG).show()
