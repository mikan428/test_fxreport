...
import com.example.fxreport.AccountSettingsActivity
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        {
            view.edi_account_settings_btn.text = "Edit Profile"
        }
        ...
        view.edi_account_settings_btn.setOnClickListener{
           val getButtonText = view.edi_account_settings_btn.text.toString()
           ...
           if (followRef != null)
           {
               followRef.addValueEventListener(object  : ValueEventListener
               {
                   override fun onDataChange(p0: DataSnapshot)
                   {
                         ...
                         {
                             view?.edi_account_settings_btn?.text = "Folloing"
                         }
                         else{
                             view?.edi_account_settings_btn?.text = "Follow"
                         }
                   }
        ...
        usersRef.addValueEventListener(object  : ValueEventListener
        {
            ...
            override fun onDataChange(p0: DataSnapshot)
            {
                  ...
                  if (p0.exists())
                  {
                      ...
                      Picasso.get().load(user!!.getImage()).placeholder(R.drawable.profile).into(view?.pro_image_frag)
